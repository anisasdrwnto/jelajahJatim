...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link
        href="https://fonts.googleapis.com/css2?family=Inria+Serif:ital,wght@0,700;1,400&family=Instrument+Sans:wght@400;500;600;700&display=swap"
        rel="stylesheet">
...
<body>
                        ...
                        <?php if(isset($_SESSION['user_id'])): ?>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><span class="dropdown-item-text fw-semibold"><?= htmlspecialchars($_SESSION['nama']) ?></span></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" href="/api/php/profile.php"><i class="bi bi-person me-2"></i>Edit Profil</a></li>
                                    <li><a class="dropdown-item text-danger" href="/api/php/logout.php"><i class="bi bi-box-arrow-right me-2"></i>Keluar</a></li>
                                </ul>
                            </div>
                        <?php else: ?>
        ...
        <div class="container">
            ...
            <div class="pinterest-grid">
                ...
                <div class="pinterest-card">
                    <div class="card-image">
                        <img src="/assets/event1.jpeg" alt="Banyuwangi Ethno Carnival">
                    ...
                    <div class="card-content">
                        <div class="card-meta">
                            ...
                            <div class="card-date">
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24"
                                    fill="none" stroke="#888" stroke-width="2" stroke-linecap="round"
                        ...
                        <button type="button" class="btn card-btn w-100 mt-3 rounded-3 py-2 fw-semibold">Daftar
                            Sekarang</button>
                    </div>
                </div>
                ...
                <div class="pinterest-card">
                    <div class="card-image">
                        <img src="/assets/event2.jpg" alt="Ijen Geopark Run 2026">
                        <div class="card-overlay"></div>
                    </div>
                    <div class="card-content">
                        <div class="card-meta">
                        ...
                        <p>Tantang dirimu berlari melintasi jalur vulkanik dengan pemandangan Kawah Ijen yang tak
                            terlupakan.</p>
                        <button type="button" class="btn card-btn w-100 mt-3 rounded-3 py-2 fw-semibold">Daftar
                            Sekarang</button>
                    </div>
                ...
                <div class="pinterest-card">
                    <div class="card-image">
                        <img src="/assets/event3.jpg" alt="Gandrung Sewu">
                        <div class="card-overlay"></div>
                    </div>
                    <div class="card-content">
                        <div class="card-meta">
                        ...
                        <h3>Gandrung Sewu</h3>
                        <p>Saksikan ribuan penari membawakan tarian Gandrung secara kolosal di tepi pantai Banyuwangi.
                        </p>
                        <button type="button" class="btn card-btn w-100 mt-3 rounded-3 py-2 fw-semibold">Daftar
                            Sekarang</button>
                    </div>
            ...
            <div class="event-button">
                <button type="button"
                    ...
                    onclick="window.location.href='/php/more.php'"
                    ...
                    Lihat selengkapnya
                    <span
                        class="position-absolute end-0 me-2 d-inline-flex align-items-center justify-content-center rounded-circle"
                ...
                <form>
                    <div class="row g-3 mb-3">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control ulasan-input"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="dropdown w-100">
                                ...
                                <ul class="dropdown-menu w-100 mt-1 shadow">
                                    <li><a class="dropdown-item custom-option" href="#">Banyuwangi Ethno Carnival</a>
                                    </li>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control ulasan-input" rows="4"
                            placeholder="Ceritakan pengalaman Anda di sini..."></textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="upload-area" id="uploadArea">
                            ...
                            <p>
                                <span class="upload-link" onclick="document.getElementById('fileInput').click()">Klik di
                                    sini</span>
                    ...
                    <div class="d-grid">
                        <button type="submit"
                            class="btn ulasan-btn d-inline-flex align-items-center justify-content-center gap-2">
                            Kirim
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 100" preserveAspectRatio="none"
                ...
                <defs>
                    <pattern id="leafPat" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
                        ...
                        <path d="M55,15 Q65,-10 75,15 Q65,40 55,15 Z" fill="#3a8c63" opacity="0.7"
                            transform="rotate(25 65 15)" />
                        <path d="M5,65 Q12,48 20,65 Q12,82 5,65 Z" fill="#52b788" opacity="0.6"
                            transform="rotate(-15 12 65)" />
                        <path d="M60,60 Q70,42 80,60 Q70,78 60,60 Z" fill="#2d6a4f" opacity="0.5"
    ...
    <script>
        ...
        window.addEventListener('scroll', () => {
            ...
            if (scrollY > 200) {
                // sudah scroll ke bawah — tombol ke atas
                scrollIcon.className = 'bi bi-chevron-up';
            } else {
                // masih di atas — tombol ke section kegiatan
                scrollIcon.className = 'bi bi-chevron-down';
            }
        });
        ...
        //Register ke register.php
        $('#btnRegister').on('click', function() {
            window.location.href = BASE_URL + 'php/register.php';
        });
    </script>
