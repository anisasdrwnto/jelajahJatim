<div class="modal modal-blur fade" id="modalEditEvent" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">

      <div class="modal-header">
        <h5 class="modal-title">Edit Event Wisata</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <form id="formEditEvent">
        <input type="hidden" name="action" value="edit">
        <input type="hidden" id="edit_id_event"  name="id">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="editNamaEvent" name="namaEvent" required>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="mb-3">
            ...
            <div class="col-lg-4">
              <div class="mb-3">
                ...
                <input type="date" class="form-control" id="editTanggalEvent" name="tanggalEvent" required>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="mb-3">
                <label class="form-label required">Waktu Mulai</label>
                <input type="time" class="form-control" id="editWaktuMulai" name="waktuMulai" required>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="mb-3">
                <label class="form-label required">Waktu Selesai</label>
                <input type="time" class="form-control" id="editWaktuSelesai" name="waktuSelesai" required>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="mb-3">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary ms-auto" id="btnUpdateEvent">
